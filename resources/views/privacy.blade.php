<x-guest-layout>
    ...
    <div class="min-h-screen bg-background">
        ...
        <main class="mx-auto max-w-3xl px-4 py-12 text-sm leading-relaxed text-foreground">
            ...
            <p class="mt-2">
                You can permanently delete your account and all of its data at any time, directly
                from the app — no need to contact us first. See
                <a href="{{ route('account-deletion') }}" class="text-primary underline">Account Deletion</a>
                for exactly how, and exactly what gets removed.
            </p>
